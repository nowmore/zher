...
- **⚡ Zero Configuration**: Single executable file. No database setup, no complex config. Double-click to start.
- **🔒 Privacy Focused**: Your data stays in your local network.
